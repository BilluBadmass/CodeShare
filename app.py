...
STORAGE_FILE = "rooms_storage.json"
...
def load_storage():
    if os.path.exists(STORAGE_FILE):
        try:
            ...
            pass
    return {"rooms": {}, "room_files": {}, "room_chats": {}}
...
room_files = storage.get("room_files", {})
room_chats = storage.get("room_chats", {})
connections = {}
...
let ws = new WebSocket(protocol + location.host + "/ws/__ROOM__");
